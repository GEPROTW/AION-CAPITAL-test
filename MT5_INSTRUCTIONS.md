...
- **FirebaseProjectId**: (已自動填入) `cultivated-buckeye-vcf5x`
- **DatabaseId**: (已自動填入) `ai-studio-17650b85-623c-4900-bca4-05c721c83378`
- **WebApiKey**: (已自動填入) `AIzaSyDMYR1VPwgFaU8zaF_6m1_JtMzEszVQj0g`

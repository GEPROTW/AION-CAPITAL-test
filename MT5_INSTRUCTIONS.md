...
- **FirebaseProjectId**: 請輸入您的專案 ID (`cultivated-buckeye-vcf5x`)
- **DatabaseId**: 由於系統使用了非預設的資料庫名稱，請輸入此值 (`ai-studio-17650b85-623c-4900-bca4-05c721c83378`)
- **WebApiKey**: 輸入之前複製的 Web API Key (`AIzaSyDMYR1VPwgFaU8zaF_6m1_JtMzEszVQj0g`)
